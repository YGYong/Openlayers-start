...
这案例让我想到了实习的时候，考核就是绘制箭头线，一晃好几年过去了，仍历历在目...

## 介绍

1. 使用`Math.atan2(dy, dx)`计算角度
2. 需要准备一张箭头图片
3. `forEachSegment`遍历线条的每个线段，`rotateWithView: true`让箭头随地图旋转
...
<video controls>
  <source src="./assets/25_绘制箭头线.mp4" type="video/mp4" />
  您的浏览器不支持HTML5视频标签。
</video>
