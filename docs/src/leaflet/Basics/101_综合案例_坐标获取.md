...
展示如何监听地图的点击事件，并在页面上实时显示点击位置的经纬度坐标
  ...
  <div class="map-wrapper">
    <div class="control-panel">
      ...
      <div class="info-display">
        <p>点击地图获取坐标：</p>
        <p>
          <strong>经度 (Lng):</strong>
          {{ clickedCoords.lng ? clickedCoords.lng.toFixed(6) : "N/A" }}
        </p>
        <p>
          <strong>纬度 (Lat):</strong>
          {{ clickedCoords.lat ? clickedCoords.lat.toFixed(6) : "N/A" }}
        </p>
      </div>
...
<video controls>
  <source src="./imgs/01_坐标获取.mp4" type="video/mp4" />
  您的浏览器不支持HTML5视频标签。
</video>
